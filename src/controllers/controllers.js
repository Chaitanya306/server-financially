...
import {login,signup,home,createTransaction,statsDashboard,userDetails,deleteTransactions} from '../routes/routes.js'
...
router.delete('/financeApp/deleteTransactions',auth,deleteTransactions)
